import { Waypoints, TrendingUp, BrainCircuit, FingerprintPattern } from "lucide-react";
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-brand-700 p-12 text-white lg:flex">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-md text-white/70">
            Nexora brings your leads, contacts, and follow-ups together
            — helping you turn every opportunity into a closed deal with AI-powered 
            insights.
          </p>

          <div className="mt-10 space-y-4">
            {[
              { icon: TrendingUp, text: "Move deals through every stage with ease." },
              { icon: BrainCircuit, text: "Prioritize prospects and draft emails in seconds." },
              { icon: FingerprintPattern, text: "Your data stays private, protected, and yours." },
            ].map(({ icon: Icon, text }) => (
