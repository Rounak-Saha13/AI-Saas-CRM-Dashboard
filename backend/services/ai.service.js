...
const generateJSON = async (prompt, schema) => {
    ...
    try{
        ...
        throw new ApiError (502, "AI Req Failed. Please be back in a moment.")
    }
    };
    ...
    const generateText = async (prompt, temperature = 0.7) => {
        ...
        export const generateLeadSummary = async (lead) => {
            const prompt = `You are an expert B2B sales analyst for an crm called Nexora.
        ...
        Recipient (lead) details:
            ...
            Use line breaks (\\n) in the body. Keep it under 180 words. Sign off as ${
                sender?.name || "the Nexora CRM Team"
            },`;
        ...
        export const generateSalesInsights = async (pipelineStats) => {
            ...
            sales pipeline, identify what is working, what is at risk and concfrete actions
            ...
            const schema = {
                ...
                properties:{
                    ...
                    recommendations: {
                        type: "array",
                        description: "3-5 priortized, actionable recommendations. ",
                        items: {type:"string"}
                    }, 
                    healthScore: {
                        type: "integer",
                ...
                required: ["headline", "riskScore", "recommendations", "healthScore"],
            };
